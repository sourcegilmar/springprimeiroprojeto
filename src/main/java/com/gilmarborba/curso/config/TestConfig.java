package com.gilmarborba.curso.config;
...
import com.gilmarborba.curso.entities.Payment;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// VAMOS FAZER O SEED PARA A TABELA

		// Fica no início pois não tem dependências
		...
		// Para salvar um objeto dependente um para um, não uso o repository
		o1.setPayment(pay1);
